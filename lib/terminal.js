...
var iconv = new Iconv("Big5-HKSCS", "UTF-8//IGNORE");
var iconvEnabled = true
var convertToUTF8 = function(buffer) {
	if (!iconvEnabled) {
		return buffer;
	}
...
exports.setIconvEnabled = function(enabled) {
	iconvEnabled = enabled
}
...
Terminal.prototype = {
	...
	toString: function(locateCursor) {
		...
		convertedRet = convertToUTF8(buffer).toString();
		return convertedRet;
	},
	setLed: function(n) {
		if(n == 0)
